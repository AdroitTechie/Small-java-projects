...
public class TicTacToe {
    ...
    public static void main(String[] args) {
       ...
       while(true){
           ...
           while(ur_set.contains(user_pos)|| com_set.contains(user_pos)){
               System.out.println();
            System.out.print("Re-Enter values from 1-9 : ");
             user_pos = sc.nextInt();
           }
           ...
           while(ur_set.contains(cpu_pos)|| com_set.contains(cpu_pos)){
             
             cpu_pos = gen_random();
           }
           place_holder(g_board, cpu_pos, "Comp");
